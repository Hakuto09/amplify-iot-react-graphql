      ...
      <table border="1" width="1000">
        <thead className="table-dark">
          <tr>
            ...
            {/*<th scope="col-3">nickname</th>*/}
            <th scope="col-3">device_id</th>
            <th scope="col-4">send_cnt</th>
            <th scope="col-5">temp</th>
            <th scope="col-6">general_data00</th>
