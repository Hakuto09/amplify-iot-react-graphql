...
//          console_logger.warn('filterNotes(): in switch: result2 ', result2);
      ...
      case 'general_data00' :
        ...
        else if(selectedFilterSymbol.value == '>')  { notesFiltered = notes.filter((note) => (note.general_data00 > Number(elemFilterInput.value))); }
        else                                        { notesFiltered = notes.filter((note) => (note.general_data00 < Number(elemFilterInput.value))); }
        break;
    }
