...
//const App = async ({ signOut }) => {
  ...
  console_logger.warn('App() After useState():', ' startDate ', startDate);
  const [endDate, setEndDate] = useState()
  console_logger.warn('App() After useState():', ' endDate ', endDate);
  const [startTime, setStartTime] = useState()
  console_logger.warn('App() After useState():', ' startTime ', startTime);
  const [endTime, setEndTime] = useState()
  console_logger.warn('App() After useState():', ' endTime ', endTime);
