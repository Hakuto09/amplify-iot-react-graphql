...
const App = ({ signOut }) => {
  ...
  async function fetchNotes() {
    console_logger.error('fetchNotes(): In')  // Hakuto
    console_logger.warn('fetchNotes(): In')  // Hakuto
    console_logger.info('fetchNotes(): In')  // Hakuto
    console_logger.debug('fetchNotes(): In')  // Hakuto
//    const apiData = await API.graphql({ query: listNotes });
    const apiData = await client.graphql({ query: listNotes });
    console_logger.error('fetchNotes(): After client.graphql() apiData --> ', apiData);  // Hakuto
    console_logger.warn('fetchNotes(): After client.graphql() apiData --> ', apiData);  // Hakuto
    console_logger.info('fetchNotes(): After client.graphql() apiData --> ', apiData);  // Hakuto
    console_logger.debug('fetchNotes(): After client.graphql() apiData --> ', apiData);  // Hakuto
    const notesFromAPI = apiData.data.listNotes.items;
    console_logger.error('fetchNotes(): After client.graphql() notesFromAPI --> ', notesFromAPI)  // Hakuto
    console_logger.warn('fetchNotes(): After client.graphql() notesFromAPI --> ', notesFromAPI)  // Hakuto
    console_logger.info('fetchNotes(): After client.graphql() notesFromAPI --> ', notesFromAPI)  // Hakuto
    console_logger.debug('fetchNotes(): After client.graphql() notesFromAPI --> ', notesFromAPI)  // Hakuto
    setNotes(notesFromAPI);
    // Hakuto start
    console_logger.error('fetchNotes(): After setNotes() notesFromAPI --> ', notesFromAPI)
    console_logger.warn('fetchNotes(): After setNotes() notesFromAPI --> ', notesFromAPI)
    console_logger.info('fetchNotes(): After setNotes() notesFromAPI --> ', notesFromAPI)
    console_logger.debug('fetchNotes(): After setNotes() notesFromAPI --> ', notesFromAPI)
    //onMessage();
    // Hakuto end
  }
